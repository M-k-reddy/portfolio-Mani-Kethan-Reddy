  ...
  const items = [
    {
      ...
      image: './certificates/ijert-research-paper.png',
    ...
    },
    {
      ...
      image: './certificates/salesforce-agentforce.png',
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p className="section-desc" style={{ margin: '0 auto' }}>
            Verified research paper publication in IJERT and official Salesforce Certified Agentforce Specialist certification.
          </p>
        </div>
